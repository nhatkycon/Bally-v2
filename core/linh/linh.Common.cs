            ...
            string[] VietnameseSigns = new string[]
    {
        ...
        public static youTubeVideo YouTubeCode(string url)
        {
           ...
           , urlwatch));
            ...
            sb.AppendFormat(@"                              
            <a href=""javascript:;"" class=""updateShoutBox-Link-Title"">{1}</a><br />
            <span class=""updateShoutBox-Link-Link"">{2}</span><br />
            <a href=""javascript:;"" class=""updateShoutBox-Link-Mota"">{3}</a><br />                    
            <div type=""1"" _id=""{4}"" class=""updateShoutBox-Link-ImagesList"">
                <img src=""{0}"" class=""updateShoutBox-Link-Image"" /><br />        
            </div>
            ", img, title, url, desc, urlwatch);
            item.Anh = img;
            item.Ten = title;
            item.Url = url;
            item.YId = urlwatch;
