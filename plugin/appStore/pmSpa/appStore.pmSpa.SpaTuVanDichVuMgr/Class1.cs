...
[assembly: WebResource("appStore.pmSpa.SpaTuVanDichVuMgr.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.pmSpa.SpaTuVanDichVuMgr.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace appStore.pmSpa.SpaTuVanDichVuMgr
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "appStore.pmSpa.SpaTuVanDichVuMgr.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region default
