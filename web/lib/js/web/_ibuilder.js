                ...
                if (_url == 'portal-module-get') {
                    ...
                    $.each($('.thm-item'), function (i, _itemcss) {
                        ...
                        itemCss.unbind('click').click(function () {
                            ...
                            $.ajax({
                                url: domain + '/lib/ajax/Default.aspx',
                                data: {
                                    'ref': Math.random(),
                                    'act': 'saveThemes',
                                    'kyHieu': _kyhieu,
...
var homeFn = {
    moveFn: function () {
        ...
        $('.mdl-tool-edit').unbind('click').click(function () {
            ...
            common.fbAjax('Sửa', domain + '/lib/ajax/Default.aspx', { 'act': 'portal-module-edit', 'id': _id }, 600, 'edit-mdl-' + _id, function (b) {
    ...
    dragFn: function () {
        ...
        $('.zone-content').droppable({
            ...
            drop: function (event, ui) {
                ...
                $.ajax({
                    url: domain + '/lib/ajax/Default.aspx' + _url,
                    data: {
                        'ref': Math.random(),
